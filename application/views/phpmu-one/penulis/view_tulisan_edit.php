<?php 
    echo "<p class='sidebar-title'><span class='glyphicon glyphicon-list'></span> &nbsp; $title";
              ...
              echo form_open_multipart('users/edit_tulisan',$attributes); 
          echo "<table class='table table-condensed '>
                  <tbody>
                    ...
                    echo "</td></tr>
                    <tr><th scope='row'>Isi Tulisan</th>             <td><textarea class='ckeditor form-control' name='h' style='height:260px' required>$rows[isi_berita]</textarea></td></tr>
                    <tr><th scope='row'>Ganti Gbr</th>                 <td><input type='file' class='form-control' name='k'>";
                  ...
                  if ($cekkategori->lowker == 'Y'){
                    ...
                    echo "<table class='table table-condensed'>
                          <tbody>
                            ...
                            <tr><th width='100px' scope='row'>Perusahaan</th> <td><input type='text' class='required form-control' name='aa' value='$row[nama_perusahaan]' required></td></tr>
                    ...
                    echo "<table class='table table-condensed'>
                          <tbody>
                            <input type='hidden' name='jualbeliupdate' value='jualbeliupdate'>
                              <tr><th width='100px' scope='row'>Produk</th> <td><input type='text' class='required form-control' name='aa' value='$row[nama_produk]' placeholder='Tuliskan nama produk anda,...' required></td></tr>

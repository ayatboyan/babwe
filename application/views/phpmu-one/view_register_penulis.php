    ...
    echo $this->recaptcha->getScriptTag(); // javascript recaptcha 
          echo "<p class='sidebar-title'><span class='glyphicon glyphicon-file'></span> $title</p>
            ...
            if (isset($_POST['submit'])){
                ...
                echo form_open_multipart('auth/penulis',$attributes); 
                    echo "<input type='hidden' value='penulis' name='v'>
                    ...
                    <div class='form-group'>
                        ...
                        <div style='background:#fff;' class='input-group col-sm-6'>
                            <input type='text' class='required form-control' name='q' required>
                        </div>
                        </div>
                    </div>
                    ...
                    <div class='form-group'>
                        ...
                        <div class='col-sm-9'>
                        <div style='background:#fff;' class='input-group col-sm-6'>
                            <input type='text' class='required form-control' name='r' required>
                        </div>
                        </div>
                    </div>
                    ...
                    <div class='form-group'>
                        ...
                        <div class='col-sm-9'>
                        <div style='background:#fff;' class='input-group col-sm-6'>
                            <input type='number' class='required form-control' name='s' required>
                        </div>
                        </div>
                    </div>

           ...
           <!--HALAMAN UTAMA MULAI DARI INFORMASI TERBARU -->

            <p class='sidebar-title'><span class='glyphicon glyphicon-th-list'></span> &nbsp; INFORMASI TERBARU</p><hr>
            <?php 
            ...
            <?php 
                $iklantengah = $this->model_iklan->iklan_tengah(1);
                                ...
                                echo "<div role='tabpanel' class='tab-pane fade active in' id='$rowk[kategori_seo]' aria-labelledby='$rowk[kategori_seo]-tab'>
                                        <div class='col-md-12'>
                                            <div class='col-md-6'>";
                                              ...
                                              foreach ($kategori_content->result_array() as $row){
                                                ...
                                                echo "<a class='judul' href='".base_url()."berita/detail/$row[judul_seo]'>".$row['judul']."</a><hr>
                                                      ...
                                                      <p>$isi...</p>
                                                      <a class='btn btn-xs btn-info' href='".base_url()."berita/detail/$row[judul_seo]'>Lihat Detail &raquo;</a>
                                                      <div style='clear:both'><br></div>";
                                              }
                                            echo "</div>
                                            ...
                                            <div class='col-md-6'>";
                                              ...
                                              echo "<a class='btn btn-xs btn-success' href='berita/kategori/$rowk[kategori_seo]'>Lihat Semuanya &raquo;</a>
                                              <div style='clear:both'><br></div>
                                            </div> 
                                        </div>  
                                      </div>";
                                ...
                                echo "<div role='tabpanel' class='tab-pane fade' id='$rowk[kategori_seo]' aria-labelledby='$rowk[kategori_seo]-tab'>
                                        <div class='col-md-12'>
                                            ...
                                            <div class='col-md-6'>";
                                              ...
                                              echo "<a class='btn btn-xs btn-success' href='".base_url()."berita/kategori/$rowk[kategori_seo]'>Lihat Semuanya &raquo;</a>
                                              <div style='clear:both'><br></div>
                                            </div>
                                        </div>
                                    </div>";
